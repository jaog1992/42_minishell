...
SRC_FILE	= minishell_main.c minishell_signals.c minishell_exit.c \
				minishell_tokens.c minishell_tokens_utils1.c minishell_tokens_utils2.c \
				minishell_var_expansion.c  minishell_var_expansion_utils.c \
				minishell_data.c minishell_utils.c minishell_fd.c  \
